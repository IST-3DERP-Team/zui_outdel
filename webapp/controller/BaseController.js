sap.ui.define([
    ...
    return Controller.extend("zuioutdel.controller.BaseController", {
        ...
        showLoadingDialog(pTitle) {
            if (!_this._LoadingDialog) {
                _this._LoadingDialog = sap.ui.xmlfragment("zuioutdel.view.fragments.dialog.LoadingDialog", _this);
